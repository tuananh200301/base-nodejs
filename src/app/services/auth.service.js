...
import {cache, LOGIN_EXPIRE_IN, LINK_STATIC_URL, TOKEN_TYPE, LINK_RESET_PASSWORD_URL} from '@/configs'
...
export async function sendMailForgotPassword(currentUser) {
    const token = generateToken({user_id: currentUser._id}, TOKEN_TYPE.FORGOT_PASSWORD, 600)
    await sendMail(currentUser.email, 'Quên mật khẩu', 'emails/forgot-password.html', {
